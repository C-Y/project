        ...
        <section class="content"> <!-- .box-body -->
            <div class="box box-primary">
                        ...
                        <table id="dataList"
                            ...
                            <c:forEach var="p" items="${page.list}">
                                <tr>
                                    ...
                                    <td>${p.cityName}</td>
                                        <%--日期格式化,改变日期样式--%>
                                    <td><fmt:formatDate value="${p.departureTime}"
                                                        pattern="yyyy-MM-dd HH:mm"></fmt:formatDate></td>
                                    <td>${p.productPrice}</td>
                                    <td class="text-center">${p.productDesc}</td>
                                    <td class="text-center">${p.productStatus == 0?'关闭':'开启'}</td>
                                    <td class="text-center">
                                        <button type="button" class="btn bg-olive btn-xs"
                                                onclick="editProduct(${p.id})">修改
                                        </button>
                                        <button type="button" class="btn bg-olive btn-xs"
                ...
                <div class="box-footer">
                    <div class="pull-left">
                        <div class="form-group form-inline">
                            总共${page.totalPage}页，共${page.totalCount}条数据。 每页 <select class="form-control">
                            <option>5</option>
                            <option>10</option>
                            <option>20</option>
                        </select> 条
                    ...
                    <div class="box-tools pull-right">
                        <ul class="pagination">
                            ...
                            <li><a href="/product/findByPage?pageNum=${page.pageNum-1}">上一页</a></li>
                            <li><a href="#">1</a></li>
                            <li><a href="#">2</a></li>
                            <li><a href="#">3</a></li>
                            <li><a href="#">4</a></li>
                            <li><a href="#">5</a></li>
                            <li><a href="/product/findByPage?pageNum=${page.pageNum+1}">下一页</a></li>
                            <li><a href="/product/findByPage?pageNum=${page.totalPage}" aria-label="Next">尾页</a></li>
                        </ul>
                    </div>
...
<script>
    ...
    function delProduct() {
        ...
        ids = ids.substring(0, ids.length - 1);
            location.href="/product/delete?ids=" + ids;
        }
    }
